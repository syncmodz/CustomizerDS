...
static const char* STRINGS[LANG_COUNT][STR_COUNT] = {
    ...
    [LANG_PT] = {
        ...
        [STR_SYSFONT_CONFIRM] = "Aplicar como fonte do SISTEMA? O console vai REINICIAR.",
        ...
        [STR_SYSFONT_INSTALLING] = "Instalando fonte do sistema",
    ...
    [LANG_EN] = {
        ...
        [STR_SYSFONT_CONFIRM] = "Apply as the SYSTEM font? The console will REBOOT.",
        ...
        [STR_SYSFONT_INSTALLING] = "Installing system font",
        [STR_HELP_FONTS_X] = "X system font",
    ...
    [LANG_ES] = {
        ...
        [STR_SYSFONT_CONFIRM] = "Aplicar como fuente del SISTEMA? La consola se REINICIARA.",
        ...
        [STR_SYSFONT_INSTALLING] = "Instalando fuente del sistema",
        [STR_HELP_FONTS_X] = "X fuente del sistema",
