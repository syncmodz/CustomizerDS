...
void menuRenderTop(C2D_TextBuf buf) {
    ...
    UI_TextCenter(buf, NULL, "CDS", 32 + slideUp * 0.25f + logoS * 0.5f, 68 + slideUp, 0.50f, 0.50f, g_theme.onPrimary);

    UI_Text(buf, fontsCurrent(), "CustomizerDS", 104, 54 + slideUp, 0.58f, 0.58f, g_theme.textPrimary);
