...
void fontsRenderTop(C2D_TextBuf buf) {
    ...
    UI_Panel(16, 58, 368, 130, g_theme.surface, g_theme.divider);
...
void fontsRenderBottom(C2D_TextBuf buf) {
    ...
    if (s_selY + 26 > SCREEN_BOT_HEIGHT - 24) s_selY = (float)(SCREEN_BOT_HEIGHT - 24 - 26);
    ...
    for (int i = 0; i < fontsCount(); i++) {
        ...
        UI_Button(buf, fontsGetFont(i), 10, 38 + i * 30, 300, 26,
